        ...
        <div ref={ref} className="reveal grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-4 p-5 bg-warm rounded-2xl border border-blush/20">
              ...
              <a href="mailto:valeriagongora3026@gmail.com" className="text-navy/70 hover:text-navy transition-colors">
            ...
            <div className="flex items-center gap-4 p-5 bg-warm rounded-2xl border border-blush/20">
              ...
              <span className="text-navy/70">{t(tr.availability)}</span>
            </div>
            ...
            <div className="flex gap-3 pt-2 flex-wrap">
              ...
              <a href="https://wa.me/573135281338" target="_blank" rel="noopener noreferrer"
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M20.52 3.48A11.94 11.94 0 0 0 12 .5C5.65.5.5 5.65.5 12c0 2.11.55 4.16 1.6 5.97L.5 23.5l5.7-1.5A11.9 11.9 0 0 0 12 23.5c6.35 0 11.5-5.15 11.5-11.5 0-3.07-1.2-5.96-3.48-8.52Z"/></svg>
                WhatsApp
              </a>
            </div>
          </div>
