...
export default function Contact() {
  ...
  return (
    <section className="py-16 md:py-24 bg-cream scroll-mt-20" id="contacto">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-wrap gap-3 pt-2 justify-center">
            <a href="https://github.com/valeriaucc" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 px-5 py-2.5 bg-navy text-cream text-sm rounded-full hover:bg-navy-mid transition-colors">
