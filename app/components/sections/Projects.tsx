        ...
        >
          {tr.items.map((project, i) => (
            <motion.div
              ...
              className="group relative bg-cream/5 border border-cream/10 rounded-2xl p-7
                         hover:bg-cream/10 hover:border-cream/20 hover:shadow-2xl hover:shadow-navy/50
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.skills[lang].map((s: string, j: number) => (
                  <span key={j} className="text-xs px-2.5 py-1 bg-cream/5 border border-cream/10 text-cream/50 rounded-full">
                    {s}
                  </span>
                ))}
              </div>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {project.tech.map((tech) => (
                  <span key={tech} className="text-xs px-2.5 py-1 bg-navy-mid/40 text-blush/80 rounded-full font-medium">
                    {tech}
                  </span>
                ))}
              </div>
              ...
              <div className="mt-auto flex flex-wrap gap-4 items-center">
                {project.demo && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-sm text-cream/60 hover:text-cream transition-colors duration-200 group/link"
                  >
                ...
                {project.github && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 text-sm text-cream/60 hover:text-cream transition-colors duration-200 group/gh"
                  >
