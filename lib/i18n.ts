...
export const translations = {
  ...
  about: {
    ...
    p1: {
      es: "Soy estudiante de Ingeniería de Software en Colombia, con enfoque en desarrollo web y creación de soluciones digitales funcionales, escalables y centradas en la experiencia de usuario. Me enfoco en desarrollo frontend, creando interfaces modernas, dinámicas e intuitivas que integran diseño, usabilidad y rendimiento.",
      en: "I'm a Software Engineering student in Colombia, focused on web development and the creation of functional, scalable, and user-experience-centered digital solutions. I focus on frontend development, building modern, dynamic, and intuitive interfaces that integrate design, usability, and performance.",
    },
    p2: {
      es: "Durante mi formación he participado en proyectos académicos de aplicaciones web, análisis de datos, IoT e integración de inteligencia artificial, lo que me ha permitido desarrollar una visión integral del proceso de software. He trabajado con tecnologías como React, Next.js, JavaScript, Tailwind CSS, Git, SQL y AWS. Actualmente hago parte del equipo de desarrollo e investigación TuringCode y de la comunidad académica Code in Place de Stanford University.",
      en: "During my studies I have participated in academic projects involving web applications, data analysis, IoT, and artificial intelligence integration, which has allowed me to develop a comprehensive view of the software process. I have worked with technologies such as React, Next.js, JavaScript, Tailwind CSS, Git, SQL, and AWS. I am currently part of the TuringCode development and research team and the Code in Place academic community at Stanford University.",
    },
    p3: {
      es: "También integro el equipo estudiantil CiberGuardianas, donde fortalezco conocimientos en ciberseguridad y promuevo buenas prácticas de protección de la información.",
      en: "I am also a member of the CiberGuardianas student team, where I strengthen my knowledge of cybersecurity and promote good practices for information protection.",
    },
    p4: {
      es: "Actualmente busco oportunidades remotas y proyectos freelance para seguir creciendo y aportar valor mediante soluciones tecnológicas innovadoras, creativas y centradas en el usuario.",
      en: "I am currently seeking remote opportunities and freelance projects to keep growing and contribute value through innovative, creative, and user-centered technological solutions.",
    },
    extras: [
      { es: "Certificación B1 en inglés — Evolve Your English (2023–2024)",                  en: "B1 English Certification — Evolve Your English (2023–2024)" },
      { es: "Ingeniería de Software — Universidad Cooperativa de Colombia (2024 – actual)",   en: "Software Engineering — Universidad Cooperativa de Colombia (2024 – present)" },
    ...
    strengths: [
      { title: { es: "Desarrollo Frontend",   en: "Frontend Development" }, desc: { es: "Interfaces modernas, dinámicas e intuitivas que integran diseño, usabilidad y rendimiento.", en: "Modern, dynamic, and intuitive interfaces that integrate design, usability, and performance." } },
      { title: { es: "Stack & Equipos",       en: "Stack & Teams"        }, desc: { es: "TuringCode, Code in Place (Stanford) · React, Next.js, Tailwind CSS, Git, SQL y AWS.", en: "TuringCode, Code in Place (Stanford) · React, Next.js, Tailwind CSS, Git, SQL, and AWS." } },
      { title: { es: "CiberGuardianas",       en: "CiberGuardianas"      }, desc: { es: "Equipo estudiantil de ciberseguridad: protección de la información y buenas prácticas digitales.", en: "Student cybersecurity team: information protection and digital best practices." } },
      { title: { es: "Freelance & Remoto",    en: "Freelance & Remote"   }, desc: { es: "Busco proyectos freelance y oportunidades remotas para aportar valor con soluciones innovadoras.", en: "Seeking freelance projects and remote opportunities to add value through innovative solutions." } },
    ],
  },
